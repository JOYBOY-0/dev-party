      ...
      <Layout className='mb-20'>
        ...
        >
          ...
          <div className='flex flex-col items-start max-w-xs '>
            ...
            />
            <div className='flex space-x-6 font-primary py-8'>
              {formFields.tags.length === 0 ? (
                <div className='flex shrink-0 flex-col items-center justify-center w-24 h-24 border-2 border-slate-700 rounded-lg border-dashed'>
